...
def main():
    print("=" * 90)
    print("V2.13 DINOv2 浮雕增强多视图古埃及符号图像匹配测试")
    print("=" * 90)
    print("候选库：1072 个符号 × 6 种浮雕风格 = 6432 个增强样本")
    print("策略：DINOv2 图像 embedding + 多查询视图 + sign_id 聚合")
    ...
    while True:
        ...
        try:
            results, view_names, full_results = match_dinov2_multiview(
                image_path=image_path,
                top_k=50
            )

            print_results(results, view_names)
